...
\begin{itemize}
    ...
    \item \textbf{Repository}: Includes code for starting the database and for executing queries needed by the services. The ORM tool used is NORM.  \todo{argue for why}\\
...
\todo{Describe report pulling and creation}
