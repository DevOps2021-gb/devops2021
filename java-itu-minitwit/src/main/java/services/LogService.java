...
public class LogService {
    ...
    public static void logError(Exception e, Class theClass) {
        ...
        logger.log(Level.INFO, new StringBuilder(className).append(e.getMessage()).toString());
    }

    public static void logErrorWithMessage(Exception e, String message, Class theClass) {
        String className = theClass.getSimpleName();
        Logger logger = Logger.getLogger(className);
        logger.log(Level.INFO, new StringBuilder(className).append(message).append("  :  ").append(e.getMessage()).toString());
    }
