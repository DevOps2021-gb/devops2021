...
class QueriesTest {
    ...
    Result<Boolean> registerAndLogin(String username, String password) {
        this.register(username, password, null, null);
    ...
    Result<Integer> registerLoginGetID(String username, String password, String password2, String email) {
        this.register(username, password, password2, email);
    ...
    void testLoginLogout() {
        ...
        result = this.logout();
        //TODO will always succeed as is now
        assert result.isSuccess() && result.get();
        result = this.login("user2", "wrongpassword");
        assert !result.isSuccess();
        assert result.getFailureMessage().equals("Invalid username");
        result = this.login("user1", "wrongpassword");
        assert !result.isSuccess();
        assert result.getFailureMessage().equals("Invalid password");
    }
