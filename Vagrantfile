...
Vagrant.configure("2") do |config|
  ...
  config.ssh.private_key_path = 'ssh_keys/java_minitwit'
  ...
  config.vm.define "minitwit", primary: true do |server|
    ...
    server.vm.provider :digital_ocean do |provider|
      provider.ssh_key_name = "java_minitwit"
    ...
    server.vm.hostname = "java-minitwit-ci-server"
    ...
    echo -e "\nVagrant setup done ..."
    echo -e "minitwit will later be accessible at http://$(hostname -I | awk '{print $1}'):4567"
